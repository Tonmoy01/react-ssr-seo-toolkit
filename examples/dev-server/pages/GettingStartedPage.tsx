  ...
  return (
    <Layout pageConfig={pageConfig} activeRoute="/getting-started">
      <div className="page-header">
        ...
        <p>
          Install react-ssr-seo-toolkit and add production-ready SEO to your app in minutes.
        </p>
      </div>
        ...
        <div className="callout callout-source">
          ...
          <div className="callout-content">
            <p>
              ...
              Open Graph, and Twitter Card meta tags generated by react-ssr-seo-toolkit.
            </p>
          </div>
        </div>
      </div>
